...
function CludeLib:CreateWindow(name)
	...
	function Window:CreateTab(tabName)
		...
		function Tab:AddSection(text, side)
			...
			addTextStroke(SectionLabel)

			local Section = {}
			SectionLabel.Parent = (side == "left" and TabContent.Left) or (side == "right" and TabContent.Right) or error("Invalid side, use 'left' or 'right'")
			...
			function Section:AddButton(buttonText, callback)
				...
				AddButton.Size = UDim2.new(1, 0, 0, 36) -- smaller height to fit UI better
				...
				AddButton.Parent = SectionLabel.Parent
